...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='output_same_page_value51510/best_model.pt')
    parser.add_argument('--output_dir', type=str, default='output_same_page_value51510_best')
    parser.add_argument('--device', type=str, default='cuda' if torch.cuda.is_available() else 'cpu')
    parser.add_argument('--num_episodes', type=int, default=10)
    parser.add_argument('--max_steps', type=int, default=200)
    parser.add_argument('--num_samples', type=int, default=8)
    parser.add_argument('--max_step_norm', type=float, default=12)
    parser.add_argument('--encoding_dim', type=int, default=256, help='Dimension of encoded state')  # 修改为256以匹配训练模型
    parser.add_argument('--hidden_dim', type=int, default=512)
    parser.add_argument('--encoder_embedding', type=int, default=192)
    parser.add_argument('--temperature', type=float, default=1.0)
    parser.add_argument('--encoder_type', type=str, default='vit', choices=['vit', 'cnn'])  # 修改默认值为vit
